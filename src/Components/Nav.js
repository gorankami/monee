...
import { PAGE_NAME_CONFIG, PAGE_NAME_OVERVIEW, PAGE_NAME_TRANSACTIONS } from './Pages/pageNames'
...
export default function Nav() {
  ...
  return (
    <>
      <div
        className={getActiveIf(PAGE_NAME_OVERVIEW)}
        onClick={() => setActive(PAGE_NAME_OVERVIEW)}
      >
        Overview
      </div>
      <div
